...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ImagePicker.instance?.imageLoader(CoilIVLoader())
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        ImagePicker.instance?.onActivityResult(requestCode, resultCode, data)
        if (requestCode == 2) {
    ...
    /*
    * 裁剪地址 context.getExternalFilesDir(Environment.DIRECTORY_PICTURES)?.absolutePath!! + "/ImagePicker/cropTemp/"
    * */
}